...
def test():
    ...
    a.add_last_stack(867)
    a.add_last_stack(4)
    print('Список из стэков: ')
    a.print_all_top()
    print('Отсортированный список: ')
    a.shaker_sort()
    a.print_all_top()
    a.get_stack(0).push(44)
    print('Список после добавление в первый стэк 44 ( a.get_stack(0).push(44 )): ')
    a.print_all_top()
    print('Отсортированный список: ')
    a.shaker_sort()
    a.print_all_top()
    ...
    a.get_stack(5).pop()
    print('Список после извлечения из 6-го стэка ( a.get_stack(5).pop() ): ')
    a.print_all_top()
    print('Отсортированный список: ')
    a.shaker_sort()
    a.print_all_top()
